...
import {ArrowRight,MapPin,Calendar,DollarSign,Users, ClipboardList,Ruler,Activity,Repeat,SmilePlus,Layers,UserCheck,Search,MessageCircle,ChevronDown,ShieldCheck} from "lucide-react";
    ...
    <section className="w-full rounded-3xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative px-6 py-8 sm:px-12 sm:py-12 bg-white rounded-b-3xl shadow-[0_8px_10px_-4px_rgba(0,0,0,0.45)]">
        ...
        <p className="relative text-[#161E54] text-sm sm:text-base md:text-lg max-w-5xl">
          Braces straighten teeth, improve bite alignment, and enhance your smile.
          They're a long-term investment in your oral health and confidence.
        </p>
      </div>
    </section>
  );
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            >
              ...
              >
                Achieve a Straighter, Healthier Smile with Orthodontic Braces
              </motion.h1>
              ...
              >
                Braces involve a comprehensive assessment of your teeth and bite to identify alignment and spacing issues early.
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              variants={textItem}
            >
              Braces help correct alignment issues before they lead to long-term dental problems.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              {
                imageSrc: "/images/diastema1.jpg",
                title: "Gaps Between Teeth",
                full: "Spacing issues such as diastema can affect appearance and lead to food trapping. Braces help close gaps and create a balanced, aligned smile."
              },
              {
                imageSrc: "/images/displacement.jpg",
                title: "Displaced Teeth",
                full: "Teeth that are crowded, rotated, or displaced can interfere with proper cleaning and bite function. Braces gradually reposition teeth into proper alignment."
              },
              {
                imageSrc: "/images/malocclusion.jpg",
                title: "Malocclusion",
                full: "When the upper and lower teeth do not meet correctly, chewing and jaw comfort are affected. Braces correct bite alignment and improve overall oral function."
              },
                  ...
                  {[
                    {
                      ...
                      description:
                        "Your teeth, bite, and jaw alignment are examined. X-rays and photographs may be taken to plan treatment.",
                    ...
                    },
                    {
                      ...
                      description:
                        "A personalized plan is created to determine the type of braces and expected treatment duration.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Braces are carefully placed on your teeth to begin gradual and controlled alignment.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Scheduled visits allow for adjustments, progress checks, and guidance throughout treatment.",
                  ...
                  >
                    <ul className="space-y-5">
                      {[
                        {
                          icon: SmilePlus,
                          title: "Correct Alignment Early",
                          text: "Braces identify and correct misaligned teeth before they cause bite or jaw problems.",
                        },
                        {
                          icon: Ruler,
                          title: "Improved Bite & Function",
                          text: "Gradually realigns teeth to ensure proper chewing, speaking, and jaw comfort.",
                        },
                        {
                          icon: Layers,
                          title: "Prevent Future Complications",
                          text: "Correcting misalignment early reduces the risk of uneven wear, TMJ issues, and other dental problems.",
                        },
                        {
                          icon: UserCheck,
                          title: "Customized Orthodontic Care",
                          text: "Treatment plans are tailored to your needs, ensuring safe and effective results throughout.",
                        },
            ...
            >
              ...
              >
                <h2 className="text-xl sm:text-lg font-bold text-[#071c2f]">
                  Everything you need to know before your braces procedure.
                </h2>
              </motion.div>
              ...
              <div className="grid lg:grid-cols-2 gap-10 items-start">
                ...
                >
                  {[
                      {
                        q: "Who needs braces?",
                        a: "Braces are recommended for patients with misaligned teeth, bite problems, or spacing issues that affect function or appearance.",
                      },
                      {
                        q: "Are braces painful?",
                        a: "Braces may cause mild discomfort or pressure initially, but this usually eases as your teeth adjust. Regular adjustments are generally well-tolerated.",
                      },
                      {
                        q: "How long will I need to wear braces?",
                        a: "Treatment duration varies depending on the severity of alignment issues, but most patients wear braces between 12 and 36 months.",
                      },
                      {
                        q: "Will I need follow-up visits?",
                        a: "Yes. Regular appointments are required to adjust braces, monitor progress, and ensure treatment stays on track.",
                      },
                  ].map((item, index) => (
                    <motion.details
                      key={index}
