...
import {ArrowRight,MapPin,Calendar,DollarSign,Users,ScanFace,Ruler,BookOpen,Smile,ClipboardCheck,ChevronDown,ShieldCheck} from "lucide-react";
import { motion, cubicBezier, type Variants } from "framer-motion";

export const RetainersHero = () => {
  const subtitle =
    ...
    <section className="w-full rounded-3xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative px-6 py-8 sm:px-12 sm:py-12 bg-white rounded-b-3xl shadow-[0_8px_10px_-4px_rgba(0,0,0,0.45)]">
        ...
        <p className="relative text-[#161E54] text-sm sm:text-base md:text-lg max-w-5xl">
          Retainers are essential after braces to maintain your new smile.
          They help keep teeth in their corrected positions and prevent shifting.
        </p>
      </div>
    </section>
  );
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            >
              ...
              >
                Maintain Your Perfect Smile with Professional Retainers
              </motion.h1>
              ...
              >
                Retainers help maintain the alignment of your teeth after orthodontic treatment by keeping them in their corrected position.
                By preventing teeth from shifting back over time, retainers preserve your smile, support proper bite function, 
                and protect the results of braces or aligners—ensuring long-term stability and confidence.
              </motion.p>
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/retainers.png')",
              }}
            >
              {/* Buttons Overlay */}
              <motion.div
            ...
            <div className="px-6 mt-4 md:hidden mb-6">
              <Link href="/appointments">
                ...
                >
                  <span>Book Retainers Appointment</span>
                  <ArrowRight className="w-5 h-5 stroke-[2.2]" />
                </motion.button>
              </Link>
            </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            {[
              {
                imageSrc: "/images/braces3.jpg",
                title: "Post-Braces Retainers",
                full: "After braces are removed, retainers are essential to hold teeth in their corrected position while the surrounding bone and gums stabilize. Without proper retention, teeth can gradually shift back toward their original alignment."
              },
              {
                imageSrc: "/images/bruxism.jpg",
                title: "Bruxism Protection",
                full: "In patients with bruxism, retainers or night-time appliances help protect teeth from grinding-related wear, fractures, and jaw strain, while also maintaining tooth alignment."
              },
              {
                imageSrc: "/images/retainerinvasalign.png",
                title: "After Invisalign Retention",
                full: "After completing Invisalign treatment, retainers are prescribed to preserve the final tooth positions achieved. Consistent retainer use prevents relapse and maintains long-term treatment results."
              }
            ].map((item) => (
                  <motion.div
                    key={item.title}
          ...
          >
                  ...
                  {[
                    {
                      ...
                      description:
                        "We assess your teeth alignment, bite stability, and risk of relapse following orthodontic or restorative treatment.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Accurate digital scans or impressions are taken to fabricate retainers that fit securely and comfortably.",
                      bg: "from-[#F2FBF7] to-[#E6F3EE]",
                    },
                    {
                      step: "03",
                      icon: ShieldCheck,
                      title: "Retainer Fabrication & Fitting",
                      description:
                        "Your custom retainer is fitted to ensure proper retention, comfort, and long-term tooth stability.",
                      bg: "from-[#F6F4FA] to-[#ECE9F3]",
                    },
                    {
                      step: "04",
                      icon: BookOpen,
                      title: "Wear & Care Guidance",
                      description:
                        "You receive clear instructions on retainer wear schedules, cleaning methods, and long-term maintenance.",
            ...
            >
              <div className="bg-[#eaf4fb] rounded-3xl overflow-hidden shadow-lg">
                ...
                >
                  Benefits of Wearing Retainers After Orthodontic Treatment
                </motion.h2>
                  ...
                  >
                    <ul className="space-y-5">
                      {[
                          {
                            icon: ShieldCheck,
                            title: "Maintain Teeth Alignment",
                            text: "Retainers hold your teeth in their corrected position, preventing unwanted shifting after braces or Invisalign.",
                          },
                          {
                            icon: Smile,
                            title: "Protect Your Smile",
                            text: "By keeping teeth stable, retainers help maintain a confident, healthy smile long-term.",
                          },
                          {
                            icon: Calendar,
                            title: "Long-Term Stability",
                            text: "Consistent retainer use ensures that your treatment results last for years without relapse.",
                          },
                          {
                            icon: ClipboardCheck,
                            title: "Personalized Retainer Guidance",
                            text: "Receive expert instructions on wearing, cleaning, and caring for your retainers to maximize effectiveness.",
                          },
            ...
            >
              ...
              >
                <h2 className="text-xl sm:text-lg font-bold text-[#071c2f]">
                  Everything you need to know before wearing a retainer.
                </h2>
              </motion.div>
              ...
              <div className="grid lg:grid-cols-2 gap-10 items-start">
                ...
                >
                  {[
                    {
                      q: "Who needs to wear a retainer?",
                      a: "Anyone who has completed orthodontic treatment, such as braces or Invisalign, or has had minor tooth movement that needs stabilization.",
                    },
                    {
                      q: "How long should I wear my retainer?",
                      a: "Initially, retainers are usually worn full-time for a few months, then nightly as recommended by your dentist or orthodontist to maintain alignment.",
                    },
                    {
                      q: "Are retainers uncomfortable or painful?",
                      a: "Retainers may feel slightly tight at first, but they are generally comfortable. Any soreness usually resolves within a few days.",
                    },
                    {
                      q: "How do I care for my retainer?",
                      a: "Clean your retainer daily with a soft toothbrush and lukewarm water. Avoid hot water and harsh chemicals that could warp it.",
                    },
                    {
                      q: "What happens if I stop wearing my retainer?",
                      a: "Teeth can gradually shift back to their original position, undoing the results of orthodontic treatment. Long-term compliance is essential.",
                    },
                    {
                      q: "Can retainers fix new alignment problems?",
                      a: "No. Retainers are designed to maintain alignment, not correct new misalignments. Any new movement should be evaluated by a dentist or orthodontist.",
                    },
                  ].map((item, index) => (
                    <motion.details
                      key={index}
