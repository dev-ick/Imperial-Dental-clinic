...
import {ArrowRight,BrickWall,MapPin,Calendar,DollarSign,Users,Smile,Ban,Thermometer, Cuboid,
        ClipboardCheck,Sparkles,ChevronDown,ShieldCheck, Palette} from "lucide-react";
import { motion, cubicBezier, type Variants } from "framer-motion";

export const WhiteFillingsHero = () => {
  const subtitle =
    ...
    <section className="w-full rounded-3xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative px-6 py-8 sm:px-12 sm:py-12 bg-white rounded-b-3xl shadow-[0_8px_10px_-4px_rgba(0,0,0,0.45)]">
        ...
        <p className="relative text-[#161E54] text-sm sm:text-base md:text-lg max-w-5xl">
          Routine checkups catch issues early, protecting your teeth and gums.
          They keep your smile healthy and confident.
        </p>
      </div>
    </section>
  );
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            >
              ...
              >
              White fillings are a safe and aesthetically pleasing solution to repair teeth affected by decay or minor damage. 
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2
              ...
              variants={textItem}
            >
              Who Should Get a white fillings procedure?
            </motion.h2>
            ...
            <motion.p
              ...
              variants={textItem}
            >
              White fillings restore teeth naturally, blending with your smile while repairing cavities,gaps or chips.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              {
                imageSrc: "/images/cavities.jpg",
                title: "Dental Cavities",
                full: "Tooth‑colored fillings repair cavities by sealing out decay, preventing further damage, and blending seamlessly with your smile."
              },
              {
                imageSrc: "/images/diastema.jpg",
                title: "Tooth Gaps",
                full: "Composite fillings close small gaps between teeth, reshaping your smile for better alignment and a more confident look."
              },
              {
                imageSrc: "/images/worn.jpg",
                title: "Worn Out Teeth",
                full: "White fillings rebuild worn teeth by restoring lost structure, strengthening bite function, and keeping a natural appearance."
              },
            ].map((item) => (
                  <motion.div
                    key={item.title}
                  ...
                  {[
                    {
                      ...
                      description:
                        "We check your teeth, gums, and bite. X-rays may be taken if required.",
                    ...
                    },
                    {
                      ...
                      description:
                        "A composite material is carefully chosen to match your natural tooth color.",
                    ...
                    },
                    {
                      ...
                      description:
                        "The resin is applied in layers, hardened with light, and sculpted to restore function.",
                    ...
                    },
                    {
                      ...
                      description:
                        "The filling is polished for a smooth, natural look that blends seamlessly with your smile.",
                  ...
                  >
                    <ul className="space-y-5">
                      {[
                        {
                          icon: Smile,
                          title: "Restore Tooth Function",
                          text: "Fillings repair cavities or damage, allowing you to chew and bite normally again.",
                        },
                        {
                          icon: Ban,
                          title: "Prevent Further Decay",
                          text: "By sealing off the affected area, fillings stop bacteria from spreading deeper into the tooth.",
                        },
                        {
                          icon: Thermometer,
                          title: "Relieve Pain",
                          text: "Treating cavities reduces discomfort from hot, cold, or sweet foods.",
                        },
                        {
                          icon: Cuboid,
                          title: "Protect Tooth Structure",
                          text: "Fillings strengthen weakened teeth and help preserve them instead of needing extraction.",
                        },
                      ].map((benefit) => (
                        <motion.li
                          key={benefit.title}
            ...
            >
              ...
              >
                <h2 className="text-xl sm:text-lg font-bold text-[#071c2f]">
                  Everything you need to know before your white fillings procedure.
                </h2>
              </motion.div>
              ...
              <div className="grid lg:grid-cols-2 gap-10 items-start">
                ...
                >
                  {[
                    {
                      q: "Why would I need a white filling?",
                      a: "White fillings are used to repair cavities, chips, or cracks in teeth. They restore strength and function while blending naturally with your smile.",
                    },
                    {
                      q: "Is getting a white filling painful?",
                      a: "The procedure is usually quick and comfortable. Dentists use local anesthesia to numb the area, so most patients feel little to no pain.",
                    },
                    {
                      q: "How long do white fillings last?",
                      a: "With good oral hygiene and regular dental checkups, white fillings can last many years. They are durable enough for everyday chewing and biting.",
                    },
                    {
                      q: "What if the filling wears down or breaks?",
                      a: "Your dentist can easily repair or replace a white filling. Regular checkups help catch any issues early before they become bigger problems.",
                    },
                  ].map((item, index) => (
                    <motion.details
                      key={index}
