...
import {ArrowRight,MapPin,Calendar,DollarSign,Users,Scissors,Layers,Smile,ClipboardCheck,Sparkles,Search,MessageCircle,ChevronDown,ShieldCheck} from "lucide-react";
import { motion, cubicBezier, type Variants } from "framer-motion";

export const PorcelainVeneersHero = () => {
  const subtitle =
    ...
    <section className="w-full rounded-3xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative px-6 py-8 sm:px-12 sm:py-12 bg-white rounded-b-3xl shadow-[0_8px_10px_-4px_rgba(0,0,0,0.45)]">
        ...
        <p className="relative text-[#161E54] text-sm sm:text-base md:text-lg max-w-5xl">
          Porcelain veneers transform chipped or stained teeth into a flawless smile.
          They give you lasting confidence with natural-looking results.
        </p>
      </div>
    </section>
  );
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            >
              ...
              >
                Porcelain veneers are thin, custom-made shells designed to cover the front surface of your teeth, correcting imperfections such as chips, stains, or gaps.
                By providing a natural-looking, durable solution, veneers enhance your smile’s appearance, boost confidence, and protect your teeth from further wear, helping you maintain a radiant and lasting smile.
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/porcelain2.jpg')",
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              variants={textItem}
            >
              Porcelain veneers provide a natural-looking, durable solution that restores confidence by correcting stains, chips, gaps, and uneven teeth in a single treatment.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              {
                imageSrc: "/images/fluorisis.jpg",
                title: "Fluorosis",
                full: "White or brown spots caused by excess fluoride during tooth development. Cosmetic treatments like veneers or whitening can restore a natural look."
              },
              {
                imageSrc: "/images/hollywood.jpg",
                title: "Hollywood Smile",
                full: "Porcelain veneers and cosmetic dentistry create a flawless, radiant smile. They correct chips, stains, and gaps for lasting confidence."
              },
              {
                imageSrc: "/images/crooked.jpg",
                title: "Crooked Teeth",
                full: "Misaligned teeth affect chewing, speech, and confidence. Orthodontic options like braces or aligners gradually straighten teeth for better function and aesthetics."
              }
            ].map((item) => (
                  <motion.div
                    key={item.title}
                  ...
                  {[
                    {
                      ...
                      description:
                        "We examine tooth shape, color, and alignment to determine if veneers are the right solution.",
                    ...
                    },
                    {
                      ...
                      description:
                        "A thin layer of enamel is carefully reshaped to allow veneers to fit naturally.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Impressions are taken and veneers are crafted to match your desired shade and contour.",
                      bg: "from-[#F6F4FA] to-[#ECE9F3]",
                    },
                    {
                      step: "04",
                      icon: Smile, 
                      title: "Bonding & Final Touch",
                      description:
                        "Veneers are permanently bonded, giving you a flawless, confident smile.",
                      ...
                      {[
                        {
                          ...
                          text: "Porcelain veneers mimic real teeth, blending seamlessly for a confident, radiant appearance.",
                        },
                        {
                          icon: Sparkles, 
                          title: "Stain Resistance",
                          text: "Veneers resist coffee, tea, and tobacco stains, keeping your smile bright for years.",
                        },
                        {
                          icon: ShieldCheck, 
                          title: "Durability & Strength",
                          text: "Made from strong porcelain, veneers protect worn or chipped teeth and last long-term.",
                        },
                        {
                          icon: Layers, 
                          title: "Customized Fit",
                          text: "Each veneer is tailored to your tooth’s shape and shade, ensuring comfort and a personalized result.",
                        },
                      ].map((benefit) => (
                        <motion.li
                          key={benefit.title}
                  ...
                  {[
                    {
                      ...
                      a: "The procedure is generally painless. Local anesthesia may be used during preparation to ensure comfort.",
                    },
                    {
                      q: "How long do porcelain veneers last?",
                      a: "With proper care, veneers can last 10–15 years or more before needing replacement.",
                    },
                    {
                      q: "Do veneers look natural?",
                      a: "Yes. Veneers are custom-made to match your teeth’s color and shape, blending seamlessly with your smile.",
                    },
                    {
                      q: "Can anyone get veneers?",
                      a: "Most patients with healthy teeth and gums are candidates. Your dentist will assess suitability during consultation.",
                    },
                  ].map((item, index) => (
                    <motion.details
                      key={index}
