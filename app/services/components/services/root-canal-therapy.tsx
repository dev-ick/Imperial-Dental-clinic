...
import {ArrowRight,MapPin,Calendar,DollarSign,Users,Droplet,ScanLine,Syringe,Bug,PackageCheck,Smile,Shield,ChevronDown,ShieldCheck} from "lucide-react";
import { motion, cubicBezier, type Variants } from "framer-motion";

export const RootCanalTherapyHero = () => {
  const subtitle =
    ...
    <section className="w-full rounded-3xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative px-6 py-8 sm:px-12 sm:py-12 bg-white rounded-b-3xl shadow-[0_8px_10px_-4px_rgba(0,0,0,0.45)]">
        ...
        <p className="relative text-[#161E54] text-sm sm:text-base md:text-lg max-w-5xl">
          Root canal therapy saves teeth that are severely infected or damaged.
          They relieve pain, keep your smile healthy and confident.
        </p>
      </div>
    </section>
  );
...
const deckCardVariant = (index: number) => {
  ...
  return {
    hidden: {
      scale: 0.75,  
      opacity: isMiddle ? 0.9 : 0.6,  
      x: isMiddle ? 0 : direction * 4,  
      y: 60,  
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            >
              ...
              >
                Relieve Pain, Preserve Your Smile with Root Canal Therapy
              </motion.h1>
              ...
              >
              Root Canal Therapy involves carefully removing infection from the inner tooth to relieve pain and preserve your natural smile.
              By treating deep decay or damage before it worsens, RCT helps save teeth that might otherwise be lost, prevents the spread of infection, and restores comfort and function.
              This advanced treatment not only protects your oral health but also keeps your smile strong, confident, and long-lasting
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/RCT3.jpg')",
              }}
            >
              {/* Buttons Overlay */}
              <motion.div
            ...
            <div className="px-6 mt-4 md:hidden mb-6">
              <Link href="/appointments">
                ...
                >
                  <span>Book A Root Canal Appointment</span>
                  <ArrowRight className="w-5 h-5 stroke-[2.2]" />
                </motion.button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2
              ...
              variants={textItem}
            >
              Who Should Get a Root Canal Therapy?
            </motion.h2>
            ...
            <motion.p
              ...
              variants={textItem}
            >
             Persistent or severe pain may mean infection has reached the tooth pulp — RCT relieves pain and saves the tooth.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              {
                imageSrc: "/images/decay.jpg",
                title: "Tooth Decay",
                full: "Severe or persistent pain may signal deep decay or infection in the tooth pulp — RCT removes the source of pain and saves the natural tooth."
              },
              {
                imageSrc: "/images/trauma.jpg",
                title: "Dental Trauma",
                full: "Cracks or chips that expose the inner tooth can lead to infection — timely RCT preserves the tooth’s structure and prevents further damage."
              },
              {
                imageSrc: "/images/abscess.jpg",
                title: "Routine Checkups",
                full: "Swelling, pus, or recurring abscesses indicate pulp infection — RCT eliminates bacteria, stops spread, and restores comfort and oral health."
              },
            ].map((item) => (
                  <motion.div
                    key={item.title}
          ...
          >
                  ...
                  {[
                    {
                      ...
                      description:
                        "We examine the affected tooth and take X‑rays to assess the extent of infection or damage.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Local anesthesia is applied to ensure a pain‑free procedure and patient comfort throughout.",
                    ...
                    },
                    {
                      ...
                      description:
                        "The canals are sealed, and the tooth is restored with a filling or crown for long‑term protection.",
            ...
            >
              <div className="bg-[#eaf4fb] rounded-3xl overflow-hidden shadow-lg">
                ...
                >
                  Benefits of Regular Root Canal Therapy
                </motion.h2>
                  ...
                  >
                    <ul className="space-y-5">
                      {[
                        {
                          icon: Bug,
                          title: "Early Infection Control",
                          text: "Treat deep decay or pulp infection before it spreads to surrounding teeth and gums.",
                        },
                        {
                          icon: Smile,
                          title: "Pain Relief & Comfort",
                          text: "RCT eliminates the source of severe tooth pain, restoring comfort and function.",
                        },
                        {
                          icon: PackageCheck,
                          title: "Tooth Preservation",
                          text: "Save your natural tooth instead of resorting to extraction or implants.",
                        },
                        {
                          icon: Shield,
                          title: "Long-Term Protection",
                          text: "Sealed and restored teeth are strengthened, preventing future complications and maintaining your smile.",
                        },
                      ].map((benefit) => (
                        <motion.li
                          key={benefit.title}
            ...
            >
              ...
              >
                ...
                Everything you need to know before your Root Canal Treatment.
                </h2>
              </motion.div>
                  ...
                  {[
                    {
                      ...
                      a: "A root canal is recommended when deep decay, infection, or trauma affects the tooth pulp and threatens the tooth’s survival.",
                    },
                    {
                      q: "Is a root canal painful?",
                      a: "No. With modern anesthesia and techniques, root canals are generally comfortable and relieve the pain caused by infection.",
                    },
                    {
                      q: "Will I need X-rays before a root canal?",
                      a: "Yes. X-rays help your dentist see the extent of infection and guide precise treatment of the tooth’s root canals.",
                    },
                    {
                      q: "What happens after the root canal?",
                      a: "The tooth is sealed and usually restored with a filling or crown to ensure long-term strength and protection.",
                    },
