...
import {ArrowRight,MapPin,Calendar,DollarSign,Users, ClipboardList,ThumbsUp,ScanFace,Smile,Utensils,Layers,Settings,Search,MessageCircle,ChevronDown,ShieldCheck} from "lucide-react";
import { motion, cubicBezier, type Variants } from "framer-motion";

export const DenturesHero = () => {
  const subtitle =
    ...
    <section className="w-full rounded-3xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative px-6 py-8 sm:px-12 sm:py-12 bg-white rounded-b-3xl shadow-[0_8px_10px_-4px_rgba(0,0,0,0.45)]">
        ...
        <p className="relative text-[#161E54] text-sm sm:text-base md:text-lg max-w-5xl">
          Dentures restore missing teeth, helping you chew, speak, and smile with confidence. 
          Regular care keeps them comfortable and long‑lasting.
        </p>
      </div>
    </section>
  );
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            >
              ...
              >
                Protect Your Smile with Comprehensive, Preventive Dental Checkups
              </motion.h1>
              ...
              >
                Dental checkups involve a thorough examination of your teeth, gums, and oral tissues to detect potential problems early.
                By identifying issues such as cavities, gum disease, or wear before they progress, routine checkups help maintain oral health, 
                prevent costly treatments, and keep your smile strong and confident.
              </motion.p>
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/dentures4.jpg')",
              }}
            >
              {/* Buttons Overlay */}
              <motion.div
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              variants={textItem}
            >
              Dentures may be recommended if tooth loss or damage is affecting your ability to eat, speak, or smile comfortably.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              {
                imageSrc: "/images/wornout.jpg",
                title: "Severely Worn-Out Teeth",
                full: "Excessive tooth wear from grinding, erosion, or long-standing decay can make teeth non-restorable. Dentures help re-establish proper bite, facial height, and comfortable function."
              },
              {
                imageSrc: "/images/eduntulism.jpg",
                title: "Edentulism",
                full: "Complete loss of natural teeth leads to difficulty eating, altered speech, and facial collapse. Full dentures provide functional rehabilitation and restore facial aesthetics."
              },
              {
                imageSrc: "/images/dentrauma.jpg",
                title: "Dental Trauma",
                full: "Accidents or injuries can result in sudden loss of multiple teeth. Dentures, including immediate or temporary options, help restore appearance and function while healing takes place."
              }
            ].map((item) => (
                  <motion.div
                    key={item.title}
                  ...
                  {[
                    {
                      ...
                      description:
                        "We examine your mouth, remaining teeth, gums, and jaw structure. X-rays may be taken to assess bone and plan the denture type.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Accurate impressions of your mouth are taken to record shape, bite, and jaw alignment for a comfortable fit.",
                    ...
                    },
                    {
                      ...
                      description:
                        "A trial denture is fitted to check comfort, bite, and appearance before final fabrication.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Your final dentures are fitted, adjusted, and you receive care instructions to ensure comfort and long-term use.",
                      ...
                      {[
                        {
                          ...
                          text: "Dentures restore proper chewing function, allowing you to enjoy a wider range of foods.",
                        },
                        {
                          icon: Smile,
                          title: "Natural Facial Appearance",
                          text: "Replacing missing teeth helps maintain facial shape and supports lips and cheeks.",
                        },
                        {
                          icon: Layers,
                          title: "Balanced Bite Support",
                          text: "Dentures help evenly distribute chewing forces, improving jaw comfort and stability.",
                        },
                        {
                          icon: Settings,
                          title: "Adjustable & Replaceable Solution",
                          text: "Dentures can be adjusted, relined, or replaced over time to match changes in your mouth.",
                        },
                  ...
                  {[
                    {
                      ...
                      a: "Dentures are recommended for patients who have lost several or all teeth, or whose remaining teeth are no longer restorable.",
                    },
                    {
                      q: "Are dentures uncomfortable or painful?",
                      a: "Dentures should not be painful. Some initial adjustment is normal, and follow-up visits help ensure comfort and proper fit.",
                    },
                    {
                      q: "How long does it take to get dentures?",
                      a: "The process usually takes a few visits over several weeks, depending on whether extractions or adjustments are needed.",
                    },
                    {
                      q: "Will dentures need adjustments over time?",
                      a: "Yes. As the mouth and gums change, dentures may require relining or adjustments to maintain comfort and stability.",
                    },
                  ].map((item, index) => (
                    <motion.details
                      key={index}
