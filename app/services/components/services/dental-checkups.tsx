...
export const DentalCheckupsHero = () => {
  const subtitle =
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/checkups1.jpg')",
              }}
            >
              {/* Buttons Overlay */}
              <motion.div
            ...
            {[
              {
                imageSrc: "/images/gingivitis.png",
                title: "Bleeding Gums",
                teaser: "Blood when brushing or flossing?",
                full: "This is often the first sign of gum inflammation (gingivitis). Early checkups prevent progression to serious periodontal disease."
              },
              {
                imageSrc: "/images/pain.jpg",
                title: "Tooth Pain",
                teaser: "Ongoing pain or sensitivity to hot/cold?",
                full: "Could indicate decay, cracks, infection or exposed roots — prompt examination prevents worse damage and complex treatments."
              },
              {
                imageSrc: "/images/regular.png",
                title: "Routine Checkups",
                teaser: "No symptoms, but still recommended?",
                full: "Professional cleanings & exams every 6 months catch hidden issues early, remove tartar, and help maintain lifelong oral health."
              },
            ].map((item) => (
                  <motion.div
                    key={item.title}
                ...
                >
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Plaque and tartar are gently removed, followed by polishing.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Any signs of cavities, gum disease, or wear are identified early.",
                    ...
                    },
                    {
                      ...
                      description:
                        "You receive tailored guidance to maintain long-term oral health.",
                      ...
                      {[
                        {
                          ...
                          text: "Identify cavities, gum disease, and other issues before they worsen.",
                        },
                        {
                          icon: Sparkles,
                          title: "Cleaner, Healthier Teeth",
                          text: "Professional cleaning removes plaque and tartar you can’t reach at home.",
                        },
                        {
                          icon: DollarSign,
                          title: "Prevent Costly Treatments",
                          text: "Addressing issues early reduces the need for complex procedures later.",
                        },
                        {
                          icon: MessageCircle,
                          title: "Personalized Oral Care Advice",
                          text: "Get expert guidance tailored to your dental health needs.",
                        },
                      ].map((benefit) => (
                        <motion.li
                          key={benefit.title}
                  ...
                  {[
                    {
                      ...
                      a: "Most patients should have a checkup every six months, unless advised otherwise by their dentist.",
                    },
                    {
                      q: "Is a routine dental checkup painful?",
                      a: "No. Dental checkups are generally painless and focused on prevention and comfort.",
                    },
                    {
                      q: "Will I need X-rays during my visit?",
                      a: "X-rays are only taken when necessary to detect issues not visible during an examination.",
                    },
                    {
                      q: "What if a problem is found?",
                      a: "Your dentist will explain the issue clearly and recommend early, effective treatment options.",
                    },
                  ].map((item, index) => (
                    <motion.details
                      key={index}
