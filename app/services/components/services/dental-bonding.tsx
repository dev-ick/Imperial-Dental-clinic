...
import {ArrowRight,MapPin,Calendar,DollarSign,Hammer,Sun,Layers,Droplet,Users, ClipboardCheck,
  Palette,Smile,Shield,ChevronDown,ShieldCheck} from "lucide-react";
import { motion, cubicBezier, type Variants } from "framer-motion";

export const DentalBondingHero = () => {
  const subtitle =
    ...
    <section className="w-full rounded-3xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative px-6 py-8 sm:px-12 sm:py-12 bg-white rounded-b-3xl shadow-[0_8px_10px_-4px_rgba(0,0,0,0.45)]">
        ...
        <p className="relative text-[#161E54] text-sm sm:text-base md:text-lg max-w-5xl">
          Dental bonding repairs chips and gaps, restoring your teeth’s natural look.
          It strengthens your smile and keeps it seamless.
        </p>
      </div>
    </section>
  );
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            >
              ...
              >
                Restore Your Smile with Seamless, Natural-Looking Dental Bonding
              </motion.h1>
              ...
              >
                Dental bonding involves carefully applying a tooth-colored resin to repair chips, cracks, or gaps, restoring your teeth’s natural appearance.
                By addressing minor imperfections before they worsen, bonding improves function, prevents further damage, and keeps your smile seamless and confident
              </motion.p>
              <Link href="/appointments">
                ...
                >
                  <span className="relative z-10">
                    Book A Dental Bonding Appointment
                  </span>
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/bonding1.png')",
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2
              ...
              variants={textItem}
            >
              Who Should Get Dental Bonding Procedure?
            </motion.h2>
            ...
            <motion.p
              ...
              variants={textItem}
            >
              Dental bonding matters for everyone — especially if you’re noticing chips, cracks, or gaps in your teeth.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              {
                imageSrc: "/images/chips.png",
                title: "Chipped Teeth",
                full: "Dental bonding uses tooth-colored resin to repair chips, restoring strength and a natural look without invasive treatment."
              },
              {
                imageSrc: "/images/cracked.jpg",
                title: "Cracked Teeth",
                full: "Bonding seals minor cracks, preventing further damage while blending seamlessly with your natural tooth structure."
              },
              {
                imageSrc: "/images/gaps.jpg",
                title: "Gaps Between Teeth",
                full: "Bonding can close small spaces between teeth, improving alignment and appearance while keeping your smile seamless."
              }
            ].map((item) => (
                  <motion.div
                    key={item.title}
                  ...
                  {[
                    {
                      step: "01",
                      icon: ClipboardCheck,
                      title: "Consultation & Shade Matching",
                      description:
                        "We examine the tooth and select a resin shade that blends naturally with your smile.",
                    ...
                    },
                    {
                      ...
                      description:
                        "A tooth-colored resin is applied to the affected area to repair chips, cracks, or gaps.",
                      bg: "from-[#F2FBF7] to-[#E6F3EE]",
                    },
                    {
                      step: "03",
                      icon: Layers,
                      title: "Shaping & Sculpting",
                      description:
                        "The resin is carefully molded to restore your tooth’s natural look and feel.",
                      bg: "from-[#F6F4FA] to-[#ECE9F3]",
                    },
                    {
                      step: "04",
                      icon: Sun,
                      title: "Hardening & Polishing",
                      description:
                        "A special light hardens the resin, followed by polishing for a smooth, seamless finish.",
                      ...
                      {[
                        {
                          icon: Hammer,
                          title: "Repair Damage",
                          text: "Bonding fixes chips, cracks, and worn edges, restoring strength and appearance.",
                        },
                        {
                          icon: Palette,
                          title: "Natural Look",
                          text: "Resin is shaded to match your teeth, blending seamlessly for a flawless smile.",
                        },
                        {
                          icon: Smile,
                          title: "Confidence Restored",
                          text: "Correcting imperfections helps you feel more assured in everyday interactions.",
                        },
                        {
                          icon: Shield,
                          title: "Protective Solution",
                          text: "Bonding reinforces weakened areas, preventing further damage and costly treatments.",
                        }
                  ...
                  {[
                    {
                      ...
                      a: "Bonding typically lasts several years, depending on your oral habits and care. Regular checkups help maintain results.",
                    },
                    {
                      q: "Is dental bonding painful?",
                      a: "No. Bonding is usually painless and doesn’t require anesthesia unless it’s used to fill a cavity.",
                    },
                    {
                      q: "Will bonding look natural?",
                      a: "Yes. The resin is carefully matched to your tooth color and polished for a seamless, natural appearance.",
                    },
                    {
                      q: "Can bonding fix all types of damage?",
                      a: "Bonding is ideal for small chips, cracks, gaps, or discoloration. For larger issues, your dentist may recommend other treatments.",
                    }
                  ].map((item, index) => (
                    <motion.details
                      key={index}
