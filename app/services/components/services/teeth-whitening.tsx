...
import {ArrowRight,MapPin,Calendar,DollarSign,Users,Droplet,Flashlight,Smile, ClipboardCheck,Sparkles,RefreshCcw,ChevronDown,ShieldCheck} from "lucide-react";
import { motion, cubicBezier, type Variants } from "framer-motion";

export const TeethWhiteningHero = () => {
  const subtitle =
    ...
    <section className="w-full rounded-3xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="relative px-6 py-8 sm:px-12 sm:py-12 bg-white rounded-b-3xl shadow-[0_8px_10px_-4px_rgba(0,0,0,0.45)]">
        ...
        <p className="relative text-[#161E54] text-sm sm:text-base md:text-lg max-w-5xl">
          Teeth whitening brightens your smile, removing stains and discoloration.
          It restores confidence and helps you look your best
        </p>
      </div>
    </section>
  );
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden shadow-lg relative">
            ...
            >
              ...
              >
                Brighten Your Smile with Safe, Professional Teeth Whitening
              </motion.h1>
              ...
              >
              Teeth whitening treatments safely remove stains and discoloration caused by food, drinks, smoking or aging.
              By restoring the natural brightness of your teeth, whitening enhances your appearance, boosts confidence,
              and helps you maintain a radiant, healthy smile.
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/whitening1.jpg')",
              }}
            >
              {/* Buttons Overlay */}
              <motion.div
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2
              ...
              variants={textItem}
            >
              Who Should Get a Tooth Whitening Treatment?
            </motion.h2>
            ...
            <motion.p
              ...
              variants={textItem}
            >
              Tooth whitening makes a difference for anyone - especially if you’re noticing stains, discoloration, or a dull smile.
            </motion.p>
          </motion.div>
            ...
            {[
              {
                ...
                title: "Medication Stains",
                full: "Certain medications, like tetracycline, can leave deep stains on teeth. Professional whitening helps reduce discoloration and restore a brighter, healthier appearance."
              },
              {
                imageSrc: "/images/old.png",
                title: "Age-Related Yellowing",
                full: "As enamel thins with age, teeth naturally darken or yellow. Whitening treatments safely lift these stains, rejuvenating your smile and boosting confidence."
              },
              {
                imageSrc: "/images/smoking.jpg",
                title: "Smoking Stains",
                full: "Tobacco use often causes stubborn brown or yellow stains. Professional whitening removes these discolorations, helping you regain a clean, radiant smile."
              }
                  ...
                  {[
                    {
                      step: "01",
                      icon: ClipboardCheck,
                      title: "Assessment & Shade Match",
                      description:
                        "We examine your teeth and record their current shade to plan the whitening treatment.",
                    ...
                    },
                    {
                      ...
                      description:
                        "A professional-strength whitening gel is carefully applied to your teeth.",
                    ...
                    },
                    {
                      ...
                      description:
                        "Special light or laser may be used to activate the gel and enhance whitening results.",
                    ...
                    },
                    {
                      ...
                      description:
                        "You receive guidance on maintaining your brighter smile and avoiding future stains.",
                      ...
                      {[
                        {
                          ...
                          text: "Professional whitening removes stains and discoloration, restoring a clean, radiant look.",
                        },
                        {
                          icon: Smile,
                          title: "Boosted Confidence",
                          text: "A whiter smile helps you feel more assured in social and professional situations.",
                        },
                        {
                          icon: RefreshCcw,
                          title: "Youthful Appearance",
                          text: "Whitening reverses the dulling effects of age, giving your smile a fresher, more youthful look.",
                        },
                        {
                          icon: Users,
                          title: "Positive First Impressions",
                          text: "A bright smile enhances how others perceive you, improving both social and professional interactions.",
                        }
                      ].map((benefit) => (
                        <motion.li
                          key={benefit.title}
            ...
            >
              ...
              <div className="grid lg:grid-cols-2 gap-10 items-start">
                ...
                >
                  {[
                    {
                      q: "How often should I get tooth whitening?",
                      a: "Most patients whiten once or twice a year, but frequency depends on lifestyle habits and your dentist’s advice.",
                    },
                    {
                      q: "Is tooth whitening painful?",
                      a: "No. Professional whitening is generally safe and comfortable, though mild temporary sensitivity can occur.",
                    },
                    {
                      q: "Will whitening damage my teeth?",
                      a: "When performed under professional supervision, whitening does not harm enamel or gums.",
                    },
                    {
                      q: "What if stains are very stubborn?",
                      a: "Your dentist may recommend multiple sessions or alternative treatments like veneers for deeper discoloration.",
                    }
                  ].map((item, index) => (
                    <motion.details
                      key={index}
